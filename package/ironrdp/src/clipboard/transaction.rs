...
// Source: https://github.com/Devolutions/IronRDP/blob/bdde2c76ded7315f7bc91d81a0909a1cb827d870/crates/ironrdp-web/src/clipboard/transaction.rs
...
impl ClipboardContentValue {
    pub fn js_value(&self) -> JsValue {
        match self {
            ...
            ClipboardContentValue::Binary(binary) => {
                js_sys::Uint8Array::from(binary.as_slice()).into()
            }
        }
    }
}
