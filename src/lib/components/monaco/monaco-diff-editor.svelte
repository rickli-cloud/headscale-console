<script lang="ts">
  ...
  mode.subscribe((currentMode) => {
    ...
    /** TODO: Object literal may only specify known properties, and 'theme' does not exist in type 'IDiffEditorOptions'.ts(2353) */
  ...
  onMount(async () => {
    ...
    editor = monaco.editor.createDiffEditor(editorEl, {
