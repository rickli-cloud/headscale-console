...
// Source: https://github.com/Devolutions/IronRDP/blob/bdde2c76ded7315f7bc91d81a0909a1cb827d870/web-client/iron-remote-desktop/src/interfaces/SessionBuilder.ts
// Changes made:
// - Add data_channel
...
export interface SessionBuilder {
   ...
   * Required
   */
  data_channel(data_channel: RTCDataChannel): SessionBuilder;
  /**
   * Required
   */
  ...
  remote_clipboard_changed_callback(
    callback: RemoteClipboardChangedCallback
  ): SessionBuilder;
  /**
   * Optional
   */
  remote_received_format_list_callback(
    callback: RemoteReceiveForwardListCallback
  ): SessionBuilder;
  /**
   * Optional
   */
  force_clipboard_update_callback(
    callback: ForceClipboardUpdateCallback
  ): SessionBuilder;
